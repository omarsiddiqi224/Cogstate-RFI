  ...
  return (
    <header className="bg-white text-black px-6 py-3 flex justify-between items-center border-b">
      ...
      <div className="flex items-center gap-3">
        <div className="w-32 bg-white rounded flex items-center justify-center">
        <img src="/cogstate.svg" alt="Cogstate Logo" className="logo" />
        </div>
        <div className="w-40 bg-white flex items-center justify-center border-l py-2 px-3 border-gray-400">
        <img src="/PharmaTrialOS-logo.png" alt="Cogstate Logo" className="pharma-logo" />
        </div>
      </div>
